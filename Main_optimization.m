...
if size(s_test,1) == 0 && plot_real_against_forecast_labels
    plot_real_against_forecast_labels = false;
    warning(['The whole data set is assigned to the Training set. '...
             'Test labels vs. Forecast labels cannot be shown. '...
             'Check Main_data.m'])
    fprintf('\n');
end
if size(s_test,1) == 0 && display_performance_measures
    ...
    display_performance_measures = false;
    warning(['The whole data set is assigned to the Training set. '...
             'Performance measures cannot be shown. Check Main_data.m'])
    fprintf('\n');
else
